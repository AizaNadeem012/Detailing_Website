    ...
    <div className="font-sans text-foreground">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-12 space-y-4 text-left max-w-2xl mx-auto">
            ...
            <p><strong>Email:</strong> srv_detailing@icloud.com</p>
            <p><strong>Address:</strong>office tech solutions Dukinfield</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mb-2">Contact: +44 7375 759686 | srv_detailing@icloud.com | office tech solutions Dukinfield</p>
